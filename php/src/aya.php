...
* {
  ...
  <div class="wrapper">
   <div class="wrapper">
        <nav>
         <a href="index.php"><span class="icon1"><i class="fas fa-arrow-left"></i></span></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <div class="logo">
                <img src="img/ens.png" >
            </div>
...
<div class="user-container">
        <div class="user-card">
            <div class="user-card-info"><img class="user-img" width="150px" src="img/int2.png" ></div>
